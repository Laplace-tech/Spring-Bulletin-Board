...
public class UserRegistrationForm {
	...
	public boolean isPasswordMatch() {
		...
		log.info("Validating password match: password={}, checkPassword={}, result={}", password, checkPassword, result);
...
//	직접 작성한 Getter & Setter
	...
	public String getUserName() {
		log.info("ArticleSubmitForm @Getter getUserName called. Current userName={}", this.userName);
		return userName;
	}

	public String getPassword() {
		log.info("ArticleSubmitForm @Getter getPassword called. Current password={}", this.password);
		return password;
	}

	public String getCheckPassword() {
		log.info("ArticleSubmitForm @Getter checkPassword called. Current checkPassword={}", this.password);
		return checkPassword;
	}

	public String getEmail() {
		log.info("ArticleSubmitForm @Getter getEmail called. Current email={}", this.email);
		return email;
	}
