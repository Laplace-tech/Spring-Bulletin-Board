...
public class ArticleApiController {
	...
	public ResponseEntity<Page<ArticleViewDto>> listArticles(
		...
		Page<ArticleViewDto> articlePage = this.articleService.readArticleViewPage(pageNumber);
	...
	public ResponseEntity<List<ArticleViewDto>> listAllArticles() {
		List<ArticleViewDto> articleViewDtoList = this.articleService.readAllArticlesView();
	...
	public ResponseEntity<ArticleViewDto> detailArticle(@PathVariable("id") Long id) {
		ArticleViewDto articleViewDto = this.articleService.readArticleViewById(id);
	...
	public ResponseEntity<ArticleViewDto> modifyArticle(@PathVariable("id") Long articleID) {
...
//		return ResponseEntity.ok(articleSubmitForm);
	...
	public ResponseEntity<?> modifyArticle(@PathVariable("id") Long articleID,
		...
		ArticleViewDto modifiedArticle = this.articleService.updateArticle(articleID, 1L, articleSubmitForm);
	...
	public ResponseEntity<Void> deleteArticle(@PathVariable("id") Long articleID) {
		this.articleService.deleteArticle(articleID, 1L);
