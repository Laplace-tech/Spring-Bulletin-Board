...
public class ArticleService {
    ...
    public String findAuthorById(Long articleID) {
    	return this.findArticleById(articleID).getAuthor().getUserName();
    }
	...
	public boolean checkAuthorPermission(Long articleID, UserDetails userDetails) {
		String articleAuthor = this.findAuthorById(articleID);
		
		boolean isAuthor = userDetails.getUsername().equals(articleAuthor);
