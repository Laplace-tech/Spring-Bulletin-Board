...
public class ArticleService {
    ...
    public ArticleViewDto updateArticle(Long articleID, ArticleSubmitForm modifiedArticleForm) {
    	Article editArticle = findArticleById(articleID);
    	editArticle.updateArticle(modifiedArticleForm.getTitle(), modifiedArticleForm.getContent());
    	
    	articleRepository.save(editArticle);
    	return this.articleMapper.toViewDto(editArticle);
    }
